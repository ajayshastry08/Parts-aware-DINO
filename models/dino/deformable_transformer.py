...
class DeformableTransformer(nn.Module):
    ...
    def forward(self, srcs, masks, refpoint_embed, pos_embeds, tgt, attn_mask=None):
        ...
        if self.two_stage_type =='standard':
            ...
            """sorted_proposals = torch.topk(enc_outputs_class_unselected.max(-1)[0],topk, dim=1)[1]
            ...
            df_embed.to_csv("/home/ajay_sh/scratch/pedestrian_detection/DETR-Based/pedestrian_DINO/DINO/analysis_results/img7/image_bbox/all_roi.csv",index=False)"""
